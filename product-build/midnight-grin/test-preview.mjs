...
check(html.includes('name="quantity" value="1"'), 'quantity is exactly one');
...
check(document.querySelectorAll('.mg-grin-mark').length === 3, 'cohesive grin motif in three placements');
