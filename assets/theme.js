...
(function($){
  ...
  .html(theme.Currency.formatMoney(variant.price, theme.settings.moneyFormat))
  .show();

if (variant.compare_at_price > variant.price) {
  // update compare‑at price
  $(selectors.comparePrice, this.$container)
    .html(theme.Currency.formatMoney(variant.compare_at_price, theme.settings.moneyFormat));

  // ▶ NEW: recalc and update “You save”
  var savings = variant.compare_at_price - variant.price;
  this.$container
    .find('.you-save')
    .html('You save ' + theme.Currency.formatMoney(savings, theme.settings.moneyFormat))
    .removeClass('hide');

  // existing: show wrapper & sale styling
  ...
  // always show the price wrapper
$(selectors.priceWrapper, this.$container).removeClass('hide');
// base price styling
$(selectors.price, this.$container).removeClass(classes.onSale);
// hide compare‑at price and a11y labels
...
// hide savings badge
this.$container.find('.you-save').addClass('hide');
}
        }
      },
